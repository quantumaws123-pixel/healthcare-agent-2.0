              ...
              >
                ...
                {NOTIFS.map((n, i) => (
                  <div key={i} className="flex gap-3 py-2.5 border-b border-gray-100 dark:border-gray-800 last:border-0">
                    <div className={cn("mt-1 w-2 h-2 rounded-full shrink-0", n.urgent ? "bg-danger-500" : "bg-primary-500")} />
                    <div>
...
const NOTIFS = [
  { title: "Patient HDT-001 risk level elevated to High", time: "2 minutes ago", urgent: true },
